...
public class PasarelaService {
    ...
    /**
     * Se invoca por GET la URL: http://localhost:8080/banco-web/resources/pasarela/prueba
     * y devuelve "Todo OK"
     * @return Todo OK
     */
    @GET
     ...
     * La URL sera: http://localhost:8080/banco-web/resources/pasarela/prueba/10/hola
     * @param numero
     * @param palabra
     ...
     * La url sera: http://localhost:8080/banco-web/resources/pasarela/prueba/query?numero=10&palabra=hola
     * @param numero
     * @param palabra
     * @return mensaje con los datos introducidos
     */
     ...
     * La URL es: http://localhost:8080/banco-web/resources/pasarela/usuario/10/david/xml
     * @param edad
     * @param nombre
     ...
     * La URL es: http://localhost:8080/banco-web/resources/pasarela/usuario/10/david/json
     * @param edad
     * @param nombre
